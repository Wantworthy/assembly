...
Worker.prototype.registerProcessor = function(processorModule) {
  if(!this.postprocessors[processorModule.mimeType]) {
    this.postprocessors[processorModule.mimeType] = [];
  }

  this.postprocessors[processorModule.mimeType].push(processorModule);
};
